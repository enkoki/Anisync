...
const Navbar = ({isloggedin = false}) => {
    ...
    return (
    <header className='w-screen h-[75px] py-2 px-10 xl:px-25 flex justify-between items-center bg-[#040404] shadow-2xl fixed z-50'>
        ...
        {isloggedin ? <div className='hidden xl:flex'><LoggedIn/></div> : <Variant content="Log In"/>}
        <Hamburger/>
    </header>
    );
}
