...
const AnimeCard = ( {thumbnail=dummy, title="Dummy Thumbnail", desc=dummytext}:AnimeInfo ) => {
  return (
    <div className='flex gap-5 w-full'>
        <Image src={thumbnail} alt="anime thumbnail" className='w-[181px] h-[238px] rounded-xl bg-cover bg-center shadow-2xl'></Image>
        <div className='flex flex-col justify-center items-start gap-5'>
            <div className='text-4xl font-extrabold'>{title}</div>
            <div className='text-[#4A4A4A] font-bold'>{desc}</div>
